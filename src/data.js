export const EXERCISES = [
  {id: 'pushups', name: 'Push-ups', duration: 30},
  {id: 'squats', name: 'Squats', duration: 30},
  {id: 'plank', name: 'Plank', duration: 40},
  ...
  {id: 'mountainclimbers', name: 'Mountain Climbers', duration: 30},
  {id: 'jumpingjacks', name: 'Jumping Jacks', duration: 30},
  {id: 'wallsit', name: 'Wall Sit', duration: 40},
]
